    ...
    public class EntityDeclarationRuleTemplate : RuleTemplate<IEntityDeclaration, EntityDeclarationRuleTemplate>, IEntityDeclarationRuleTemplate
    {
        ...
        static EntityDeclarationRuleTemplate()
        {
            SourceTemplateList = new List<ISourceTemplate>()
            {
                ...
                new OnceReferenceTableSourceTemplate<IEntityDeclaration, string, IImportedClass, SingleClassGroup>(nameof(IClass.ImportedClassTable), nameof(IImportedClass.ClassGroup), TemplateClassStart<IEntityDeclaration>.Default),
