namespace EaslyCompiler
{
    ...
    public class InitializedObjectExpressionRuleTemplate : RuleTemplate<IInitializedObjectExpression, InitializedObjectExpressionRuleTemplate>, IInitializedObjectExpressionRuleTemplate
    {
        ...
        public override bool CheckConsistency(IInitializedObjectExpression node, IDictionary<ISourceTemplate, object> dataList, out object data)
        {
            ...
            Success &= InitializedObjectExpression.ResolveCompilerReferences(node, ErrorList, out IResultType ResolvedResult, out IResultException ResolvedException, out ISealableList<IExpression> ConstantSourceList, out ILanguageConstant ExpressionConstant, out ITypeName InitializedObjectTypeName, out IClassType InitializedObjectType, out ISealableDictionary<string, ICompiledFeature> AssignedFeatureTable);

            if (Success)
                data = new Tuple<IResultType, IResultException, ISealableList<IExpression>, ILanguageConstant, ITypeName, IClassType, ISealableDictionary<string, ICompiledFeature>>(ResolvedResult, ResolvedException, ConstantSourceList, ExpressionConstant, InitializedObjectTypeName, InitializedObjectType, AssignedFeatureTable);
