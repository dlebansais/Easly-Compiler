namespace EaslyCompiler
{
    ...
    public class NewExpressionRuleTemplate : RuleTemplate<INewExpression, NewExpressionRuleTemplate>, INewExpressionRuleTemplate
    {
        ...
        static NewExpressionRuleTemplate()
        {
            ...
            {
                new OnceReferenceTableSourceTemplate<INewExpression, string, IScopeAttributeFeature, ITypeName>(nameof(IScopeHolder.FullScope), nameof(IScopeAttributeFeature.ResolvedEffectiveTypeName), TemplateScopeStart<INewExpression>.Default),
                new OnceReferenceTableSourceTemplate<INewExpression, string, IScopeAttributeFeature, ICompiledType>(nameof(IScopeHolder.FullScope), nameof(IScopeAttributeFeature.ResolvedEffectiveType), TemplateScopeStart<INewExpression>.Default),
        ...
        public override bool CheckConsistency(INewExpression node, IDictionary<ISourceTemplate, object> dataList, out object data)
        {
            ...
            Success &= NewExpression.ResolveCompilerReferences(node, ErrorList, out IResultType ResolvedResult, out IResultException ResolvedException, out ISealableList<IExpression> ConstantSourceList, out ILanguageConstant ExpressionConstant, out ICompiledFeature ResolvedFinalFeature);
