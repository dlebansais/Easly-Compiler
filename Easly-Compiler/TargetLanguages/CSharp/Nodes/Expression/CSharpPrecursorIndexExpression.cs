namespace EaslyCompiler
{
    ...
    public class CSharpPrecursorIndexExpression : CSharpExpression, ICSharpPrecursorIndexExpression
    {
        ...
        {
            CSharpArgument.CSharpArgumentList(writer, expressionContext, isDeclaredInPlace, FeatureCall, skippedIndex, false, out string ArgumentListText, out IList<string> OutgoingResultList);
