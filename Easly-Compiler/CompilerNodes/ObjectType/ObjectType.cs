    ...
    public static class ObjectType
    {
        ...
        public static bool TypeConformToBase(ICompiledType derivedType, ICompiledType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            if (derivedType.ConformanceTable.IsSealed)
            {
                ...
                Debug.Assert(Result == TypeConformToBaseWithoutTable(derivedType, baseType, substitutionTypeTable, errorList, sourceLocation));
            }
            else
        ...
        private static bool PropertyTypeConformToFunctionType(IPropertyType derivedType, IFunctionType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            Result &= TypeConformToBase(OverloadResult.ResolvedEntityType.Item, derivedType.ResolvedEntityType.Item, substitutionTypeTable, errorList, sourceLocation);
        ...
        private static bool ProcedureTypeConformToProcedureType(IProcedureType derivedType, IProcedureType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            foreach (ICommandOverloadType BaseOverload in baseType.OverloadList)
            {
                ...
                foreach (ICommandOverloadType DerivedOverload in derivedType.OverloadList)
                    MatchingDerivedOverload |= CommandOverloadConformToBase(DerivedOverload, BaseOverload, substitutionTypeTable, ErrorList.Ignored, ErrorList.NoLocation);
        ...
        private static bool PropertyTypeConformToProcedureType(IPropertyType derivedType, IProcedureType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            Result &= TypeConformToBase(derivedType.ResolvedEntityType.Item, OverloadValue.ResolvedEntityType.Item, substitutionTypeTable, errorList, sourceLocation);
        ...
        private static bool IndexerTypeConformToProcedureType(IIndexerType derivedType, IProcedureType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            Debug.Assert(derivedType.ResolvedEntityType.IsAssigned);
            Debug.Assert(SingleOverload.ParameterList[derivedType.IndexParameterList.Count].ResolvedEntityType.IsAssigned);

            Result &= TypeConformToBase(derivedType.ResolvedEntityType.Item, SingleOverload.ParameterList[derivedType.IndexParameterList.Count].ResolvedEntityType.Item, substitutionTypeTable, errorList, sourceLocation);
            Result &= ExceptionListConformToBase(derivedType.SetExceptionIdentifierList, SingleOverload.ExceptionIdentifierList, errorList, sourceLocation);
        ...
        private static bool FunctionTypeConformToPropertyType(IFunctionType derivedType, IPropertyType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            foreach (IQueryOverloadType DerivedOverload in derivedType.OverloadList)
                Result &= QueryOverloadHasPropertyConformingBase(DerivedOverload, baseType, substitutionTypeTable, errorList, sourceLocation, ref MatchingOverload);
        ...
        private static bool QueryOverloadHasPropertyConformingBase(IQueryOverloadType derivedOverload, IPropertyType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation, ref bool matchingOverload)
        {
            ...
            if (!TypeConformToBase(baseType.ResolvedEntityType.Item, OverloadResult.ResolvedEntityType.Item, substitutionTypeTable, ErrorList.Ignored, ErrorList.NoLocation))
                return true;

            if (!ExceptionListConformToBase(derivedOverload.ExceptionIdentifierList, baseType.GetExceptionIdentifierList, errorList, sourceLocation))
                return false;
        ...
        private static bool ProcedureTypeConformToPropertyType(IProcedureType derivedType, IPropertyType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            bool MatchingOverload = false;
            foreach (ICommandOverloadType DerivedOverload in derivedType.OverloadList)
                Result &= CommandOverloadHasPropertyConformingBase(DerivedOverload, baseType, substitutionTypeTable, errorList, sourceLocation, ref MatchingOverload);
        ...
        private static bool CommandOverloadHasPropertyConformingBase(ICommandOverloadType derivedOverload, IPropertyType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation, ref bool matchingOverload)
        {
            ...
            if (!TypeConformToBase(OverloadValue.ResolvedEntityType.Item, baseType.ResolvedEntityType.Item, substitutionTypeTable, ErrorList.Ignored, ErrorList.NoLocation))
                return true;

            if (!ExceptionListConformToBase(derivedOverload.ExceptionIdentifierList, baseType.SetExceptionIdentifierList, errorList, sourceLocation))
                return false;
        ...
        private static bool FunctionTypeConformToIndexerTypeOverloads(IQueryOverloadType derivedOverload, IIndexerType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            Result &= TypeConformToBase(baseType.ResolvedEntityType.Item, OverloadResult.ResolvedEntityType.Item, substitutionTypeTable, ErrorList.Ignored, ErrorList.NoLocation);
        ...
        private static bool ProcedureTypeConformToIndexerTypeOverloads(ICommandOverloadType derivedOverload, IIndexerType baseType, IHashtableEx<ICompiledType, ICompiledType> substitutionTypeTable, IErrorList errorList, ISource sourceLocation)
        {
            ...
            Result &= TypeConformToBase(OverloadValue.ResolvedEntityType.Item, baseType.ResolvedEntityType.Item, substitutionTypeTable, ErrorList.Ignored, ErrorList.NoLocation);
