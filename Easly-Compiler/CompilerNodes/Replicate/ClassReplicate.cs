namespace CompilerNode
{
    ...
    /// Compiler IClassReplicate.
    /// </summary>
    public class ClassReplicate : BaseNode.ClassReplicate, IClassReplicate
    {
        #region Implementation of INodeWithReplicatedBlocks
        /// <summary>
        /// Replicated list from <see cref="BaseNode.ClassReplicate.PatternBlocks"/>.
        /// </summary>
        ...
        public void FillReplicatedList(string propertyEntityDeclaration, List<BaseNode.INode> nodeList)
        {
            ...
            {
                case nameof(PatternBlocks):
                    TargetList = (IList)PatternList;
                    break;
            }
