namespace CompilerNode
{
    ...
    /// </summary>
    public interface IProcedureFeature : IFeature, IFeatureWithName, INodeWithReplicatedBlocks, ICompiledFeature, IFeatureWithPrecursor, IFeatureWithEntity
    {
        /// <summary>
    ...
    public class ProcedureFeature : BaseNode.ProcedureFeature, IProcedureFeature
    {
        ...
        public void RestartNumberType(ref bool isChanged)
        {
            foreach (ICommandOverload Overload in OverloadList)
                Overload.RestartNumberType(ref isChanged);
        }
