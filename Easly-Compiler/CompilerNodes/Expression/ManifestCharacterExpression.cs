namespace CompilerNode
{
    ...
    public class ManifestCharacterExpression : BaseNode.ManifestCharacterExpression, IManifestCharacterExpression
    {
        ...
        public static bool IsExpressionEqual(IManifestCharacterExpression expression1, IManifestCharacterExpression expression2)
        {
            bool Result = true;
        ...
        public static bool ResolveCompilerReferences(IManifestCharacterExpression node, IErrorList errorList, out IResultType resolvedResult, out IResultException resolvedException, out ListTableEx<IExpression> constantSourceList, out ILanguageConstant expressionConstant)
        {
            resolvedResult = null;
