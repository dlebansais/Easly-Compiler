namespace CompilerNode
{
    ...
    public class ResultOfExpression : BaseNode.ResultOfExpression, IResultOfExpression
    {
        ...
        public static bool ResolveCompilerReferences(IResultOfExpression node, IErrorList errorList, out IResultType resolvedResult, out IResultException resolvedException, out SealableList<IExpression> constantSourceList, out ILanguageConstant expressionConstant)
        {
            resolvedResult = null;
