namespace CompilerNode
{
    ...
    public class CloneOfExpression : BaseNode.CloneOfExpression, ICloneOfExpression
    {
        ...
        public static bool ResolveCompilerReferences(ICloneOfExpression node, IErrorList errorList, out IResultType resolvedResult, out IResultException resolvedException, out SealableList<IExpression> constantSourceList, out ILanguageConstant expressionConstant)
        {
            resolvedResult = null;
