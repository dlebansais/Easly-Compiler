namespace CompilerNode
{
    ...
    /// Compiler IContinuation.
    /// </summary>
    public class Continuation : BaseNode.Continuation, IContinuation
    {
        #region Implementation of INodeWithReplicatedBlocks
        /// <summary>
        /// Replicated list from <see cref="BaseNode.Continuation.CleanupBlocks"/>.
        /// </summary>
        public IList<IInstruction> CleanupList { get; } = new List<IInstruction>();
        ...
        public void FillReplicatedList(string propertyName, List<BaseNode.INode> nodeList)
        {
            ...
            switch (propertyName)
            {
                case nameof(CleanupBlocks):
                    TargetList = (IList)CleanupList;
                    break;
            }
