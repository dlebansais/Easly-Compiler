namespace CompilerNode
{
    ...
    /// Compiler ICheckInstruction.
    /// </summary>
    public class CheckInstruction : BaseNode.CheckInstruction, ICheckInstruction
    {
        ...
        {
            ((IExpression)BooleanExpression).RestartNumberType();
        }
        ...
        /// </summary>
        public string InstructionToString { get { return $"check {((IExpression)BooleanExpression).ExpressionToString}"; } }

        /// <summary></summary>
        public override string ToString()
        {
            return $"Check Instruction '{InstructionToString}'";
        }
        #endregion
    }
}
