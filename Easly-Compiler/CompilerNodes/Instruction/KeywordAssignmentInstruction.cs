namespace CompilerNode
{
    ...
    /// Compiler IKeywordAssignmentInstruction.
    /// </summary>
    public class KeywordAssignmentInstruction : BaseNode.KeywordAssignmentInstruction, IKeywordAssignmentInstruction
    {
        ...
        /// </summary>
        public string InstructionToString { get { return $"{Destination}† ← {((IExpression)Source).ExpressionToString}"; } }

        /// <summary></summary>
        public override string ToString()
        {
            return $"Keyword Assignment Instruction '{InstructionToString}'";
        }
        #endregion
    }
}
