namespace CompilerNode
{
    ...
    /// Compiler IIfThenElseInstruction.
    /// </summary>
    public class IfThenElseInstruction : BaseNode.IfThenElseInstruction, IIfThenElseInstruction
    {
        #region Implementation of INodeWithReplicatedBlocks
        /// <summary>
        /// Replicated list from <see cref="BaseNode.IfThenElseInstruction.ConditionalBlocks"/>.
        /// </summary>
        public IList<IConditional> ConditionalList { get; } = new List<IConditional>();
        ...
        public void FillReplicatedList(string propertyConditional, List<BaseNode.INode> nodeList)
        {
            ...
            switch (propertyConditional)
            {
                case nameof(ConditionalBlocks):
                    TargetList = (IList)ConditionalList;
                    break;
            }
        ...
        /// </summary>
        public string InstructionToString { get { return $"if {ConditionalList.Count} conditional(s)"; } }

        /// <summary></summary>
        public override string ToString()
        {
            return $"If Then Else Instruction '{InstructionToString}'";
        }
        #endregion
    }
}
