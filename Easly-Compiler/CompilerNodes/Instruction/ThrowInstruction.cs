namespace CompilerNode
{
    ...
    /// </summary>
    public interface IThrowInstruction : IInstruction, INodeWithReplicatedBlocks
    {
        /// <summary>
        /// Gets or sets the type of the exception.
        /// </summary>
        BaseNode.ObjectType ExceptionType { get; }

        /// <summary>
        /// Gets or sets the creation routine to use.
        /// </summary>
        BaseNode.Identifier CreationRoutine { get; }
    ...
    public class ThrowInstruction : BaseNode.ThrowInstruction, IThrowInstruction
    {
        ...
        /// </summary>
        public string InstructionToString { get { return $"throw {{{((IObjectType)ExceptionType).TypeToString}}}.{CreationRoutine.Text}({Argument.ArgumentListToString(ArgumentList)})"; } }

        /// <summary></summary>
        public override string ToString()
        {
            return $"Throw Instruction '{InstructionToString}'";
        }
        #endregion
    }
}
